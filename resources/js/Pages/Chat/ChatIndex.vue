...
<ChatLayout>
    ...
    <ul class="p-2">
        ...
        <li class="px-4 py-2 my-2 flex justify-between font-semibold text-slate-400 hover:bg-slate-700 rounded-lg duration-200">
...
<div class="w-full">
    <div class="relative flex-1 flex items-center">
        <input type="text" name="" id="" class="w-full bg-slate-700 text-white rounded-lg" placeholder="Ask Laravel Ai" v-model="form.promt" @keyup.enter="submit"/>
